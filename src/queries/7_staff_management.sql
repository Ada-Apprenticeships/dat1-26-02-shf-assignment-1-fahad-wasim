...
SELECT 
    ...
    staff.first_name || ' ' || staff.last_name AS trainer_name, -- combines first and last name as full name
    COUNT(personal_training_sessions.session_id) AS session_count
FROM staff
JOIN personal_training_sessions 
    ON staff.staff_id = personal_training_sessions.staff_id -- links each trainer to their sessions
